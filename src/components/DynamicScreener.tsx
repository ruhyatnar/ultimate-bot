                ...
                >
                  ...
                  <td className="py-3 px-4 text-right">
                    <div className="flex items-center justify-end space-x-1.5">
                      ...
                      <button
                        id={`quick-buy-${c.symbol}`}
                        onClick={() => onTriggerManualBuy(c.symbol)}
                        className="px-2 py-1 rounded text-[11px] font-medium bg-emerald-600/20 text-emerald-300 hover:bg-emerald-600 hover:text-white border border-emerald-500/30 transition-colors flex items-center space-x-1"
                        title="Simulate / Trigger market entry"
                      >
                        <Zap className="w-3 h-3" />
                        <span>Buy</span>
                      </button>
                      <button
                        id={`toggle-select-${c.symbol}`}
                        onClick={() => onToggleSymbolSelect(c.symbol)}
