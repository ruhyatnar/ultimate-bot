        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-xs text-slate-400 mt-1 max-w-2xl">
              Zero dead code, asynchronous SQLite with WAL & batch queue, Ed25519 WebSocket & REST API signing, dynamic 5-factor confluence indicators, and complete paper-trading simulation.
            </p>
          </div>
